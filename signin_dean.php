        ...
        <div class="row">
            ...
            <div class="col-lg-4 ">
                <div class="card shadow text-gray-700" style="margin-top: 200px;">
                    <div class="card-body">
                        <h3 class="text-primary">Login as Department Head</h3>
                        <form action="" method="POST">
                            ...
                            <input type="submit" name="btnlogin" value="Login" class="pass_data btn btn-primary col" id="<?php $row["dean_username"]; ?>">
