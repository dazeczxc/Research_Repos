...
<body style="margin: 0">
  ...
  <div class="container pt-5">
    <div class="  pt-5">
        ...
        <div class="  pt-5">
            <h2 class="pt-2"><b>Steps in Submitting Research paper</b></h2>

            <div class="pb-3">
              <p style="font-size: 1.2rem">●  Before you signin, you must:<br>
                <span class="pl-5">*Prepare and finalize your research paper.</span><br>
                <span class="pl-5">*Save or convert your paper into PDF format.</span><br></p>
                
            </div>

            <div class="pb-3">
              <p style="font-size: 1.2rem">●  Create an account.<br>
              <img class="img-responsive" src="Images/signup.png">
            </div>

            <div class="pb-3">
              <p style="font-size: 1.2rem">●  Wait for the approval of Dean.<br>
              <img class="img-responsive"  src="Images/confirm.png" width="1000px;">
            </div>

            

            <div class="pb-3">
              <p style="font-size: 1.2rem">●  Signin your account.<br>
              <img class="img-responsive"  src="Images/signin.png">
            </div>

            <div class="pb-3">
              <p style="font-size: 1.2rem">●  Fill up the form.<br>
              <img src="Images/form.png" width="1000px;">
            </div>

            <div class="pb-5">
              <p style="font-size: 1.2rem">●  Submit the research paper.<br>
              <img class="img-responsive"  src="Images/submit.png" width="1000px;">
            </div>
