 ...
 {  
      ...
      echo '
        <div class="pb-3">
            ...
            <!-- <span class="text-gray-600">PDF File: </span><a href="#">'.$result_up['upload_file'].'</a><br> -->



        <table>
        <tr>
        <td><span class="text-gray-600  ">PDF File: </span><a href="viewPDF.php?file='.$result_up['upload_file'].'">'.$result_up['upload_file'].' <span class="text-gray-500"> Open PDF</span></a> 
        ...
        if (isset($_SESSION['student_id'])) {
            ...
            <tr>
                 <td class="pl-2" align="center"> <a class="px-5 btn btn-warning"  href="download.php?file='.$result_up['upload_file'].'">Download</a>
                </td>
                 </td>
            </tr>
        </table> 
